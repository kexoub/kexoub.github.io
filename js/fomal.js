...
function createtime1() {
  var grt = new Date("10/19/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Murasame🌿 %c 你正在访问Murasame🌿の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Murasame🌿") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Murasame🌿的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("10/19/2024 00:00:00");
...
//樱花随机api
let Dmoe = "url(https://www.dmoe.cc/random.php)";
// EEE.DOG
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://www.dmoe.cc/random.php)" class="imgbox" onclick="changeBg('url(https://www.dmoe.cc/random.php)')"></a></div>
              </div>
            </details>
